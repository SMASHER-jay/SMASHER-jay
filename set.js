...
module.exports = { session: process.env.SESSION_ID || '',
    ...
    OWNER_NAME: process.env.OWNER_NAME || "king jack",
    CAPTION : process.env.CAPTION || "JACKIE-XMD",
    NUMERO_OWNER : process.env.NUMERO_OWNER || " KING JACK",              
    ...
    BOT : process.env.BOT_NAME || 'JACKIE-MD',
